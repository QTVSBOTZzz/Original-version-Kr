...
def restart(update, context):
    ...
    if dynoRestart:
        ...
        LOGGER.info("🎋Normally Restarting☘️.")
...
help_string = '''
<b><a href='https://github.com/weebzone/WZML-X'>WeebZone</a></b> - The Ultimate Telegram Leech Bot to Upload Your File & Telegram
